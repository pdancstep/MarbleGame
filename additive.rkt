...
(define linear2
  (make-level (list (make-htrack -3 -1 .5)
                    ...
                    (make-htrack -3 -7/3 -2 '+)
                    (make-vtrack -7/3 -2 -3/2 '+)
                    (make-htrack -7/3 -5/3 -3/2 '+)
                    (make-vtrack -5/3 -3/2 -2 '+)
                    (make-htrack -5/3 -1 -2 '+)

                    (make-htrack -1 -1/3 -5/2 '+)
                    (make-vtrack -1/3 -5/2 -2 '+)
                    (make-htrack -1/3 1/3 -2 '+)
                    (make-vtrack 1/3 -2 -5/2 '+)
                    (make-htrack 1/3 1 -5/2 '+)

                    (make-htrack 1 5/3 -2 '+)
                    (make-vtrack 5/3 -2 -3/2 '+)
                    (make-htrack 5/3 7/3 -3/2 '+)
                    (make-vtrack 7/3 -3/2 -2 '+)
                    (make-htrack 7/3 3 -2 '+)
